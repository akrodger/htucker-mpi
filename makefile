...
fp6d_demo.x: libHtuckerMpi.a fp6d/AB2_FokkerPlanck6d.cpp\
             fp6d/BoundaryCondition/BoundaryCondition.cpp
	$(MPICXX) $(CFLAGS) $(OMP)\
	 fp6d/AB2_FokkerPlanck6d.cpp\
	 fp6d/BoundaryCondition/BoundaryCondition.cpp\
	 -L. -lHtuckerMpi $(LAPACK) $(LAPACKE) $(BLAS) -lm  -o fp6dDemo.x
